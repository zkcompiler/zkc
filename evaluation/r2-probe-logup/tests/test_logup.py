...
from logup_model.logup import (  # noqa: E402
    ANCHORS,
    BUS_CHALLENGE_SPACE,
    ROLES,
    Mutation,
...
from logup_model.terms import OutcomeClass  # noqa: E402
...
class ClaimGraphTest(unittest.TestCase):
    ...
    def test_double_consumption_breaks_linearity(self) -> None:
        ...
        self.assertEqual(result.code, "R2-LOGUP-012")
    ...
    def test_an_unrouted_claim_at_the_terminal_is_refused(self) -> None:
        ...
        self.assertEqual(result.code, "R2-LOGUP-013")

    def test_a_claim_cannot_be_both_consumed_and_routed_out(self) -> None:
        from dataclasses import replace

        from logup_model.logup import Residual
        ...
        self.assertIs(result.outcome, OutcomeClass.MISMATCH)
        self.assertEqual(result.code, "R2-LOGUP-014")
...
class DerivedNegativeTest(unittest.TestCase):
    ...
    def test_a_table_committed_after_its_challenge_is_the_weak_fs_shape(self) -> None:
        ...
        self.assertEqual(result.code, "R2-LOGUP-005")
    ...
    def test_a_column_the_challenge_does_not_bind_is_refused(self) -> None:
        ...
        self.assertIs(result.outcome, OutcomeClass.MISMATCH)
        self.assertEqual(result.code, "R2-LOGUP-006")
    ...
    def test_a_claim_anchoring_a_role_nothing_binds_is_refused(self) -> None:
        ...
        self.assertIs(result.outcome, OutcomeClass.MISMATCH)
        self.assertEqual(result.code, "R2-LOGUP-007")
    ...
    def test_a_core_beyond_its_claim_bound_is_refused(self) -> None:
        ...
        self.assertEqual(result.code, "R2-LOGUP-001")
    ...
    def test_a_reduction_consuming_an_undeclared_claim_is_refused(self) -> None:
        ...
        self.assertEqual(result.code, "R2-LOGUP-010")
    ...
    def test_a_redundant_binding_on_a_seal_bound_table_is_refused(self) -> None:
        ...
        self.assertIs(result.outcome, OutcomeClass.MISMATCH)
        self.assertEqual(result.code, "R2-LOGUP-018")
    ...
    def test_origin_and_seat_must_agree(self) -> None:
        ...
        self.assertEqual(result.code, "R2-LOGUP-004")
...
class FixtureCorrespondenceTest(unittest.TestCase):
    ...
    def test_a_moved_fixture_is_refused(self) -> None:
        from logup_model.logup import LogupError
