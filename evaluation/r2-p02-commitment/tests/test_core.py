...
from p02model.core import (  # noqa: E402
    CHECK,
    COMMITMENT,
    OPENING,
    QUERY,
...
from p02model.terms import OutcomeClass  # noqa: E402
...
class OperandDisciplineTest(unittest.TestCase):
    ...
    def test_stripping_the_profile_is_refused_at_publication(self) -> None:
        ...
        The core then publishes no commitment at all, which P02-CORE-013
        ...
        self.assertEqual(result.code, "P02-CORE-013")
    ...
    def test_an_opening_without_a_consumer_is_refused(self) -> None:
        ...
        self.assertIs(result.outcome, OutcomeClass.MISMATCH)
        self.assertEqual(result.code, "P02-CORE-016")
