...
ROOT = HERE.parents[2]
MODULES = ("Claims", "Execution", "Sharing", "HornerCertificate")
...
def main():
    ...
    parser.add_argument("--output", type=Path,
                        default=support.evidence.records("improvement", ""))
    ...
    audit = re.search(r"IMPROVEMENT-AUDIT-PASS declarations=(\d+) theorems=(\d+)", log.read_text())
    after = inputs(formal)
