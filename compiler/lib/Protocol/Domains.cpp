...
const DomainCatalog &installedDomains() {
  static const DomainCatalog catalog = [] {
    ...
    const std::string extensionTranscript = "merlin3.koala-bear.ext8-binomial3.rejection31le/1";
    ...
    auto result = DomainCatalog::create(
        {{extensionTranscript, "Transcript", {{"ChallengeField", extension}}, {"FieldTranscript", "IndexTranscript", "Transcript"}},
         ...
         {extension,
          "Field",
          {{"BaseField", koala}},
          {"IndexRandomness", "ExtensionField", "TwoAdicField", "Field", "CommRing",
