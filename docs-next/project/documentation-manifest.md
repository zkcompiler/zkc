...
| [`foundation/natural-modular-arithmetic.md`](../foundation/natural-modular-arithmetic.md) | Target semantic specification | `foundation` | Ordinary content-addressed natural modular-arithmetic module, exact primitive laws, typed failures, and provider boundary without root-profile expansion |
...
| [`pir/profiles/README.md`](../pir/profiles/README.md) | Target semantic specification and publication index | `pir` | Complete owner-source manifests, exact profile compilation grammar, root closures, derived identity table, and independent reconstruction boundary for six frozen upstream plus three dependent PIR profiles |
...
| [`pir/verifier-derived-query-plans.md`](../pir/verifier-derived-query-plans.md) | Target semantic specification | `pir` | Finite verifier-derived word programs, nonadaptive logical query plans, deterministic flat-Core elaboration, exact logical-to-source maps, bounds, and checked inert results |
