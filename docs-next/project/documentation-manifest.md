...
| [`pir/protocol-model.md`](../pir/protocol-model.md) | Target semantic specification | `pir` | Pre-K2 finite operational Core/Protocol snapshot retained for reconstruction and provenance |
...
| [`pir/fiat-shamir-and-composition.md`](../pir/fiat-shamir-and-composition.md) | Target semantic specification | `pir` | Pre-K2 Fiat--Shamir snapshot and historical semantic Core-composition candidate retained for later composition closure |
