...
| [`pir/fiat-shamir.md`](../pir/fiat-shamir.md) | Target semantic specification | `pir` | Active K2 transcript construction, derived influence, exact prefix, squeeze/sample, namespace, failure, and same-Core Fresh/FS definitions |
...
| [`pir/interfaces-and-plans.md`](../pir/interfaces-and-plans.md) | Target semantic specification | `pir` | K2-dependent Protocol Interface and Prover Plan subjects, total invocation and presentation maps, decision recipes, PlanRealizes, and the source-ID-free PlanWitnessSurface |
| [`pir/endpoint-projection-views.md`](../pir/endpoint-projection-views.md) | Target semantic specification | `pir` | Closed endpoint purposes, recursively total source-read disposition, whole-source-provenance-free Protocol/Interface/reachable-Plan quotients, adequacy, exact canonical bodies, and checked extraction for K3-D |
...
| [`relations/relation-model.md`](../relations/relation-model.md) | Target semantic specification | `relations` | K1-aligned relation subjects and four Interface roles, private assignments and satisfaction, split Protocol/Plan bindings, three value-bridge lanes, artifact facts, and typed grounding |
| [`relations/protocol-correspondence.md`](../relations/protocol-correspondence.md) | Target semantic specification | `relations` | Closed correspondence-question algebra, one owner-derived read manifest, structural, external, artifact, equation, commitment, and public run-grounded operations, qualified outcomes, and replay |
...
| [`oir/projection-contract.md`](../oir/projection-contract.md) | Target semantic specification | `oir` | Minimum target-semantic OIR body, local admission, exact graph/static-contract correspondence, qualified outcomes, identity, support table, and explicit Stage 4B endpoint-pairing deferral |
