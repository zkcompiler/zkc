...
> explicit finite-target elaboration gaps. All seventeen selected PIR, OIR,
> Relations, and Analysis profiles now have complete independently
> reconstructed publication artifacts. Holdout validation and independent
> identity/profile freeze remain later. The
...
| Terminal contract reopening | Opened 2026-09-03; candidate repair selected at bounded research resolution; target unchanged | Recorded in the [Terminal Contract Reopening Record](../notes/semantic-revalidation-and-redesign/terminal-contract-reopening-2026-09-03.md): the K2 Terminal law leaves a guard-true/check-false state unspecified, names a required reduction no field carries, and splits identity on a disposition tag with no discriminator. The candidate repair changes the Core body grammar and rotates the Interaction profile's sixteen-profile cone. Decision gate: one F0-V2C migration after the provider-observable audit and mechanized-kernel feasibility results, then holdout rerun and independent freeze review. |
| Schnorr claim binding reopening | Opened 2026-09-03; two candidate repairs named, the fixture-side repair recommended; target unchanged | Recorded in the [Schnorr Claim Binding Reopening Record](../notes/semantic-revalidation-and-redesign/schnorr-claim-binding-reopening-2026-09-03.md); decided with the fixture refreeze that follows the migration's publication |
