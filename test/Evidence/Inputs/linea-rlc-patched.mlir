// Patched Linea/gnark ordering witness.  Each event denotes one complete
// verification-equation coefficient, including its opening-proof material,
// before the final random-combination challenge u.
pir.protocol "linea_rlc_patched" kappa {codecs = {fr = "fr_be32", equation = "fr_be32"}, iv = "artifact-id", sponge = "toy_duplex"} policy "analysis_only_artifact" {
  ...
  %t0 = pir.begin
  %t1, %m0 = pir.slot %t0 "equation0_material" : "equation" in "equation_rlc" as "equations"
  %t2, %m1 = pir.slot %t1 "equation1_material" : "equation" in "equation_rlc" as "equations" idx 1
  %t3, %u = pir.chal %t2 deps(%m0, %m1 : !pir.val<"equation">, !pir.val<"equation">) "u" : "fr" domain "linea.kzg-equation-rlc.u" space "21888242871839275222246405745257275088548364400416034343698204186575808495617"
  pir.end %t3
