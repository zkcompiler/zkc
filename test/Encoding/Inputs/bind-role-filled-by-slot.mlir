// A role the contract says a public binding fills, filled by a prover
// message.
//
// Driven by value-profile-resolution.mlir. The fourth direction of the
// origin/seat agreement: the contract states who fills a role, and the spine
// must not disagree.
pir.protocol "logup_range_check" kappa {codecs = {scalar = "ts_be8"}, iv = "artifact-id", sponge = "toy_duplex"} policy "analysis_only_artifact" {
  ...
  %t1, %table = pir.slot %t0 "table" : profile "logup_queries" in "bus" as "table"
