// The range check with its table's digest spelled a second time.
//
// Driven by value-profile-resolution.mlir. A profiled seal-stage binding
// absorbs the digest of the content its profile describes, so the value
// carries its own material reference; a material binding on it says the same
// fact again, and two places can disagree.
