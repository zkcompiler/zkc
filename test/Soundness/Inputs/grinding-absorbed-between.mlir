...
pir.protocol "frigrind" kappa {codecs = {query_index = "ts_be8", rs = "ts_be8", ext_field = "ts_be8", pow_value = "ts_be8"}, constants = {zero = {class = "pow_value", value = "0"}}, iv = "artifact-id", sponge = "toy_duplex"} policy "analysis_only_artifact" {
  ...
  pir.end %t6
  %e = pir.reduce "frij" contract "fri" (%c : !pir.claim<"opaque_relation">) deps(%fold1, %query : !pir.val<"ext_field">, !pir.val<"query_index">) checks {consistency = "consistency"} params {johnson_m = "3", johnson_eta = "1/256", johnson_delta = "9/10"} anchors [{statement = "sha256:a8e0d4fd1cf2805185daf6d0f9234b21b842fefde3503dfd74d6919a109cdb47"}] -> !pir.claim<"fri_query_consistent">
