pir.protocol "relation_attachment_mismatch" kappa {codecs = {}, iv = "artifact-id", sponge = "toy_duplex"} {
  ...
  %thread = pir.begin
  pir.check "predicate" contract "zkc.check.relation-predicate" semantic_args {contract = "sha256:05998a94e196c41414f37e1982f06133e26f13525642c9c102b1c222b4037e25", statement = "sha256:9999999999999999999999999999999999999999999999999999999999999999"}
  pir.end %thread
